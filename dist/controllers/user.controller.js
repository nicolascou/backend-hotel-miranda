...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.send(yield users_1.default.getOne(req.params.id));
    }
    catch (err) {
...
const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
        const { error } = schemas_1.userJoiSchema.validate(req.body);
        if (error) {
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        req.body.password = encryptPassword(req.body.password);
        return res.send(yield users_1.default.update(req.body, req.params.id));
    }
    catch (err) {
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.send(yield users_1.default.delete(req.params.id));
    }
    catch (err) {

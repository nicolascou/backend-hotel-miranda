...
const getBookingById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.send(yield bookings_1.default.getOne(req.params.id));
    }
    catch (err) {
...
const createBooking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
        const { error } = schemas_1.bookingJoiSchema.validate(req.body);
        if (error) {
...
const updateBooking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.send(yield bookings_1.default.update(req.body, req.params.id));
    }
    catch (err) {
...
const deleteBooking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.send(yield bookings_1.default.delete(req.params.id));
    }
    catch (err) {

...
exports.userJoiSchema = exports.contactJoiSchema = exports.bookingJoiSchema = exports.roomJoiSchema = void 0;
const joi_1 = __importDefault(require("joi"));
exports.roomJoiSchema = joi_1.default.object({
    ...
    amenities: joi_1.default.array().items(joi_1.default.string().valid('Wifi', 'LED TV', 'AC', 'Towels', 'Shower')),
    rate: joi_1.default.number(),
    offer: joi_1.default.number(),
    available: joi_1.default.boolean()
});
exports.bookingJoiSchema = joi_1.default.object({
...
exports.contactJoiSchema = joi_1.default.object({
    name: joi_1.default.string().required(),
